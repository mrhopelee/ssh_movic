...
<tr>
<td><form action=""><input type="submit" value="用户删除"></form></td>
</tr>
</table>
</div>
...
<tr>
<td><form action=""><input type="submit" value="添加广告"></form></td>
<td><form action=""><input type="submit" value="设置广告位置"></form></td>
</tr>
</table>
</div>
...
<tr>
<td><form action=""><input type="submit" value="删除评论"></form></td>
</tr>
</table>
</div>
