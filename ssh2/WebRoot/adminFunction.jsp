...
<html>
  <head>
	...
	<style type="text/css">
		...
		#circularMenu li.home { width:48px; height:48px; left:120px; top:4px; background:url(images/marea1.png) no-repeat center center;}
		#circularMenu li.chat {width:48px; height:48px; left:200px; top:40px; background:url(images/userManage.png) no-repeat center center;}
		#circularMenu li.upload {width:48px; height:48px; left:35px; top:40px; background:url(images/mtype.png) no-repeat center center;}
		#circularMenu li.email {width:48px; height:48px;left:230px; top:115px; background:url(images/mdelete.png) no-repeat center center;}
		#circularMenu li.address {width:48px; height:48px; left:5px; top:115px; background:url(images/commentsManage.png) no-repeat center center;}
		#circularMenu li.shop {width:48px; height:48px; left:200px; top:190px; background:url(images/madd.png) no-repeat center center;}
		#circularMenu li.search {width:48px; height:48px; left:35px; top:190px; background:url(images/mupdate.png) no-repeat center center;}
		#circularMenu li.delivery {left:120px; top:225px; background:url(images/delivery.gif) no-repeat center center;}
