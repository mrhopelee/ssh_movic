...
<body>
	...
	<div style="width: 980px;margin: 0 auto;">
		...
		<form action="updateMovicAction" method="post">
			<input type="hidden" value='<s:property value="movic.movicOid"/>'
				name="movic.movicOid">
			<table class="table table-bordered">
				<tr>
					<td>电影名</td>
					<td><input type="text" required="required"
						name="movic.movicName"
						value='<s:property value="movic.movicName"/>'></td>
				</tr>

				<tr>
					<td>导演</td>
					<td><input type="text" required="required"
						name="movic.movicDirector"
						value='<s:property value="movic.movicDirector"/>'></td>
				</tr>

				<tr>
					<td>演员</td>
					<td><input type="text" required="required"
						name="movic.movicActor"
						value='<s:property value="movic.movicActor"/>'></td>
				</tr>

				<tr>
					<td colspan="2">上映时间<sx:datetimepicker
							name="movic.movicPlayDate" displayFormat="yyyy-MM-dd"
							value="%{movic.movicPlayDate}" />
					</td>
				</tr>
				...
				<tr>
					...
					<td><select name="score[0]">
							...
							<option value="8">8</option>
							<option value="9">9</option>
					</select> <s:property value="movic.movicImdbScore" /></td>
				</tr>

				<tr>
					<td>简介</td>
					<td><textarea rows="10" cols="120" required="required"
							name="movic.movicIntroduction"><s:property
								value="movic.movicIntroduction" /></textarea></td>
				</tr>
			...
			<input type="hidden" value='<s:property value="movic.movicPost" />'
				name="movic.movicPost">
		</form>
	</div>
</body>
</html>
