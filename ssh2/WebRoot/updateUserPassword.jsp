			...
			<table align="center" class="table table-hover table-bordered ">
				...
				<tr align="center">
					...
					<td><label> <input name="userName" type="text"
							id="userName" value="<%=user.getUserName()%>" readonly="readonly" />
					</label></td>
				</tr>
				<tr align="center">
					<td>新密码：</td>
					<td><label> <input name="userPassword" type="password"
							id="userPassword" />
					</label> <s:fielderror fieldName="password" /></td>
				</tr>

				<tr align="center">
					<td>确认密码：</td>
					<td><label> <input name="rePassword" type="password"
							id="rePassword" />
					</label>
					<s:fielderror fieldName="rePassword" /></td>
				</tr>

				<tr align="center">
					<td><label> <input class="btn btn-default buttom1"
							type="submit" name="Submit" value="提交" />
					</label></td>
					<td><label> <a href="index.jsp">返回主页</a>
					</label></td>
				</tr>
			</table>
		</form>
