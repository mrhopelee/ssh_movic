			...
			<table align="center" class="table table-hover table-bordered ">
				...
				<tr align="center">
					...
					<td><input name="userDisplayName" type="text"
						value="<%=user1.getUserDisplayName()%>" id="userDisplayName" />
					<s:fielderror fieldName="userDisplayName" /></td>
				</tr>
				<tr align="center">
					<td>性别：</td>
					<td><label>&nbsp男<input name="userSex" type="radio"
							value="1" checked="checked" /> 女<input type="radio"
				...
				<tr align="center">
					...
					<s:fielderror fieldName="userEmail" /></td>
				</tr>
				<tr align="center">
					<td>当前用户类型 ：</td>
