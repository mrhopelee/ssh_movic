					...
					<div class="col-md-9 movie_box">
						...
						<div class="desc1 span_3_of_2">
							<p class="movie_option">
								<strong>电影名： </strong>
								<s:property value="movic.movicName" />
							</p>
							<p class="movie_option">
								<strong>上映日期: </strong>
								<s:date format="yyyy-MM-dd" name="movic.movicPlayDate"></s:date>
							</p>
							<p class="movie_option">
								<strong>导演：</strong>
								<s:property value="movic.movicDirector" />
							</p>
							<p class="movie_option">
								<strong>演员：</strong>
								<s:property value="movic.movicActor" />
							</p>
							<p class="movie_option">
								<strong>电影类型： </strong>
								<s:iterator value="movic.movicBeloneTypes" id="mbt">
								...
								<s:if test="#session.partCommentsList.size()!=0">
									<s:iterator value="#session.partCommentsList" var="mComments">
										...
										<li>
											<div class="preview">
												<img
													src="<s:property value="#mComments.userInfo.userLogo" />"
