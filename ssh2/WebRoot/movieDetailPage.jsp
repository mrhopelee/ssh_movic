...
<html>
  ...
  <table>
  	<tr>
  		...
  		<td>：<s:property value="#request.userCountByScore[4]"/>人觉得5分力荐!</td>
  	</tr>
  	<tr>
  		<td><img alt="" src="/images/star4.png" height="30px" width="50px"></td>
  		<td>：<s:property value="#request.userCountByScore[3]"/>人觉得 4分推荐!</td>
  	</tr>
  	<tr>
  		<td><img alt="" src="/images/star3.png" height="30px" width="50px"></td>
  		<td>：<s:property value="#request.userCountByScore[2]"/>人觉得 3分还行!</td>
  	</tr>
  	<tr>
  		<td><img alt="" src="/images/star2.png" height="30px" width="50px"></td>
  		<td>：<s:property value="#request.userCountByScore[1]"/>人觉得 2分较差!</td>
  	</tr>
  	<tr>
  		<td><img alt="" src="/images/star1.png" height="30px" width="50px"></td>
  		<td>：<s:property value="#request.userCountByScore[0]"/>人觉得1分很差!</td>
  	</tr>
  </table>
...
<!-- ============================输写评论区 （开始） ===================================================== -->
  ...
  <jsp:include page="editComments.jsp"></jsp:include>
 <!-- ============================输写评论区 （结束） ===================================================== --> 
  </body>
</html>
