...
<body>
	...
	<div style="margin: 0 auto; width: 980px;">
				...
				<tr>
					...
					<td>
						<form action="movicDownloadDeleteAction" method="post">
							<input type="submit" value="删除下载文件"> <input type="hidden"
								name="mdOid" value='<s:property value="#l.mdOid" />'> <input
								type="hidden" name="movicOid"
		...
		<s:form action="movicFileUploadAction" enctype="multipart/form-data"
			method="post">
